		...
		<table class="table">
			<thead>
				<tr>
                    ...
                    <th class="columnText columnCharacterGame{if $sortField == 'gameID'} active {@$sortOrder}{/if}"><a href="{link controller='CharacterList' application='gms'}pageNo={@$pageNo}&sortField=gameID&sortOrder={if $sortField == 'gameID' && $sortOrder == 'ASC'}DESC{else}ASC{/if}{/link}">{lang}gms.acp.guild.gameID{/lang}</a></th>
				...
				{content}
					{foreach from=$objects item=$object}
						<tr class="jsCharacterRow">
							...
							<td class="columnText columnUser"><a href="{link controller='UserEdit' id=$object->userID application='gms'}{/link}" name="{lang}wcf.acp.user.edit{/lang}">{@$object->username}</a></td>
