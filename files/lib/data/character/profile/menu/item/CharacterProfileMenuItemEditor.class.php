...
class CharacterProfileMenuItemEditor extends DatabaseObjectEditor implements IEditableCachedObject {
	 ...
	 */
	protected static $baseClass = 'wcf\data\character\profile\menu\item\CharacterProfileMenuItem';
	...
	public static function resetCache() {
		CacheHandler::getInstance()->clear(WCF_DIR.'cache', 'cache.characterProfileMenu.php');
	}
}
