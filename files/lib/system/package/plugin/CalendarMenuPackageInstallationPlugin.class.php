...
/**
 * Installs, updates and deletes calendar menu items.
 *
 ...
 */
class CalendarMenuPackageInstallationPlugin extends AbstractXMLPackageInstallationPlugin {
	/**
	 ...
	 */
	public $tableName = 'calendar_menu_item';
	
	/**
	 * @see	\wcf\system\package\plugin\AbstractXMLPackageInstallationPlugin::$tagName
	 */
	public $tagName = 'calendarmenuitem';
