 ...
 */
class MonthlyCalendarMenuContent extends AbstractCalendarMenuContent {
	/**
	 * @see	\gms\system\menu\calendar\content\AbstractCalendarMenuContent::$templateName
	 */
	protected $templateName = 'calendarMonthly';

	/**
	 * @see	\gms\system\menu\calendar\content\AbstractCalendarMenuContent::setEventDates()
	 */
	public function setEventDates(EventDateList $evenDateList) {
		parent::setEventDates($evenDateList);
